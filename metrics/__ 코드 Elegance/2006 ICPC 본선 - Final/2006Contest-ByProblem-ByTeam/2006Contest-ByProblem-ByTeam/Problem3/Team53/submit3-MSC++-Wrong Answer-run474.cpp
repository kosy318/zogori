...
int main(void)
{
	...
	for(ct=0; ct<t; ct++)
	{
		...
		for(i=0; i<xv.size(); i++)
		{
			min = h - (a[1][i][1]-a[1][i][0]) > h-(a[0][i][1]-a[0][i][0]) ? h-(a[0][i][1]-a[0][i][0]) :h - (a[1][i][1]-a[1][i][0]);
			if( result > a[0][i][2] + a[1][i][2] + min)
			{
				result = a[0][i][2] + a[1][i][2] + min;
		...
		for(i=0; i<yv.size(); i++)
		{
			min = w - (a[1][i][1]-a[1][i][0]) > w-(a[0][i][1]-a[0][i][0]) ? w-(a[0][i][1]-a[0][i][0]) : w-(a[1][i][1]-a[1][i][0]);
			if( result > a[0][i][2] + a[1][i][2] + min)
			{
				result = a[0][i][2] + a[1][i][2] + min;
			}
